            ...
            <?=form_open('dashboard/lokasi') ?>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input name="lat" type="text" class="form-control" placeholder="-6.02234407" required="">
                </div>
                <div class="form-group">
                  <label>Longitude</label>
                  <input name="long" type="text" class="form-control" placeholder="100.223458" required="">
                </div>
              </div>
              <!-- /.box-body -->
