          ...
          <div class="row">
            <div class="col-sm-10">
              <div class="box box-success">
                ...
                <!-- /.box-header -->
                <?=form_open_multipart('dashboard/fasilitas') ?>
                <div class="box-body">
                  <div class="form-group">
                    <label>Judul</label>
                    <input name="id" type="hidden" value="<?=$p['id_fasilitas'] ?>">
                    <input name="judul" type="text" class="form-control" value="<?=$p['judul'] ?>" style="width:50%;">
                  </div>
                  <div class="form-group">
                    <label>Isi Berita</label>
                    <textarea name="isi" class="form-control ckeditor" rows="5" ><?=$p['isi_fasilitas'] ?></textarea>
                  </div>
                </div>
                <!-- /.box-body -->
