        ...
        <div class="panel">
          ...
          <div class="panel-body" style="padding:0;">
            <form class="form-inline" action="<?=base_url().'web/direction' ?>" method="POST" style="padding:10px 0;">
              <input type="text" name='asal' class="form-control" placeholder="Lokasi asal" required="">
              <input type="text"  name='tujuan' class="form-control" placeholder="Lokasi yang dituju" required="">
      ...
      <div class="col-sm-4 sidebar">
        <div class="panel">
          ...
          <div class="panel-body">
            ...
            <?php } ?>
            <a class="btn btn-warning btn-flat" style="float:right;" href="<?=base_url().'web/lokasi' ?>"><i class="fa fa-eye"></i> Lihat Selengkapnya</a>
          </div>
        </div>
